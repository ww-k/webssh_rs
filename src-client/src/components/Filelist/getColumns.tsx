...
const fileIconMap: Record<IViewFileStat["type"], string> = {
    d: `<span role="img" aria-label="folder" class="anticon anticon-folder"><svg viewBox="64 64 896 896" focusable="false" data-icon="folder" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M880 298.4H521L403.7 186.2a8.15 8.15 0 00-5.5-2.2H144c-17.7 0-32 14.3-32 32v592c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V330.4c0-17.7-14.3-32-32-32zM840 768H184V256h188.5l119.6 114.4H840V768z" fill="var(--ant-color-primary)"></path><path d="M372.5 256H184v512h656V370.4H492.1z" fill="var(--ant-color-primary-bg)"></path></svg></span>`,
    f: fileIcon,
    l: fileIcon,
    "?": fileIcon,
};
